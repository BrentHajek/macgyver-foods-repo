export default function FaqPage() {
    ...
    <div class="faq__page">
        ...
        <div class="browse-topics-container">
            <h3 class="faq__h3" id="topics-title">Browse Topics</h3>
        ...
        <section id="account-questions-section">
            <h3 class="faq__h3" id="account-questions-title">Account Questions</h3>
            <ul>
                <li><h4 class="faq__h4">How do I create an account?</h4></li>
        ...
        <section id="adding-removing-children-section">
            <h3 class="faq__h3" id="adding-removing-children-title">Adding Or Removing Picky Eaters</h3>
            <ul>
                <li><h4 class="faq__h4">How do I add a picky eater to my account?</h4></li>
            ...
            <ul>
                <li><h4 class="faq__h4">How do I remove a picky eater account?</h4></li>
        ...
        <section id="adding-removing-ingredients-to-pantry-section">
            <h3 class="faq__h3" id="adding-removing-ingredients-to-pantry-title">Managing Your Pantry</h3>
            <ul>
                <li><h4 class="faq__h4">How do I add ingredients to my pantry?</h4></li>
                    <p></p>
            </ul>
        </section>
        <section id="adding-removing-allergies-section">
            <h3 class="faq__h3" id="adding-removing-allergies-title">Managing Allergies In Child Profile</h3>
            <ul>
                <li><h4 class="faq__h4">My picky eater has an allergy. How do I add the allergy to his/her profile so that recipes with that allergen will be excluded?</h4></li>
                ...
                <li><h4 class="faq__h4">I accidentally added the wrong allergy to my child's account. How can I remove it?</h4></li>
        ...
        <section id="adding-removing-preferences-section">
            <h3 class="faq__h3" id="adding-removing-preferences-title">Managing Preferences In Child Profile</h3>
            <ul>
                <li><h4 class="faq__h4">I want to keep track of the ingredients my picky eater likes. How do I add preferences to my child's account?</h4></li>
                ...
                <li><h4 class="faq__h4">How do I remove preferences from my child's account?</h4></li>
        ...
        <section id="searching-recipes-section">
            <h3 class="faq__h3" id="searching-recipes-title">Recipe Searches</h3>
        </section>
    </div>
    `;
}