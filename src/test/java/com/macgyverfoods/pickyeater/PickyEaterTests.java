...
public class PickyEaterTests {
    ...
    public void shouldSaveAndLoadPreferencesChild(){
        ...
        SubChild testSubChild = new SubChild("1","2","3",testAllergy,testAllergy3);
        SubChild testSubChild2 = new SubChild("1","2","3",testAllergy4,testAllergy3);
        SubChild testSubChild3 = new SubChild("1","2","3",testAllergy2);
        subChildRepo.save(testSubChild);
        subChildRepo.save(testSubChild2);
        subChildRepo.save(testSubChild3);

        Child testChild = new Child(testSubChild,testPreference,testPreference2,testPreference3);
        Child testChild2 = new Child(testSubChild2,testPreference,testPreference2);
        Child testChild3 = new Child(testSubChild3,testPreference4);
    ...
    public void shouldSaveAndLoadChildrenToAParents(){
        ...
        Parent testParent1 = new Parent("John","Doe","JohnDoe18@gmail.com",testIngredient,testIngredient2);
        Parent testParent2 = new Parent("Test","Subject","TestSubject@gmail.com",testIngredient3,testIngredient4);
    ...
    public void shouldBeAbleToAddChildrenToAParent(){
        ...
        Child testChild2 = new Child(testSubChild2,testPreference,testPreference2);
        Child testChild3 = new Child(testSubChild3,testPreference4);
        Child testChild4 = new Child(testSubChild3,testPreference,testPreference2,testPreference3,testPreference4);
        Child testChild5 = new Child(testSubChild3,testPreference);
        childRepo.save(testChild);
        childRepo.save(testChild2);
        childRepo.save(testChild3);
